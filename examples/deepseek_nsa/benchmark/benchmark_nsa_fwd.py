...
def tilelang_sparse_attention(
    Q, K, V, BlockIndices, dim, is_causal, scale=None, block_size=64, groups=1, selected_blocks=16, block_T=128, num_stages=2, threads=64
):
...
def benchmark_nsa(
    ...
    kernel = tilelang_sparse_attention.compile(
        batch=batch_size,
        heads=head_query,
        seq_len=seq_len,
        dim=dim,
