...
def cast(value: _T, dtype: DType, round: str = "", sat: bool = True, rbits: PrimExpr | None = None, span: Span | None = None) -> _T: ...
...
def ret(val: _T) -> _T: ...
def round(x: _T, rounding_mode: str = "ties-to-even", span: Span | None = None) -> _T: ...
def rsqrt(x: _T) -> _T: ...
...
def maca_ldg_b128_bsm_predicator(
    ...
    src_addr: PrimExpr,
    offset: _T = 0,
    cache_global: _T = True,
    cache_shared: _T = True,
    evict: _T = False,
    wait: _T = True,
    cmp_lhs: _T = 1,
    cmp_rhs: _T = 1,
    cmp_type: str = "MACA_ICMP_EQ",
) -> PrimExpr: ...
...
def maca_ldg_b128_bsm(dst_addr: PrimExpr, src_addr: PrimExpr, offset: _T = 0) -> PrimExpr: ...
def maca_ldg_b64_bsm(dst_addr: PrimExpr, src_addr: PrimExpr, offset: _T = 0) -> PrimExpr: ...
def maca_arrive_gvmcnt(num: _T) -> PrimExpr: ...
def maca_arrive_bsmcnt(num: _T) -> PrimExpr: ...
def maca_barrier_inst() -> PrimExpr: ...
